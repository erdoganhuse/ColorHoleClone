...
namespace DeveGames.AudioSystem.Scripts
{
    ...
    {
        public static AudioSource CustomPlay(this AudioSource audioSource)
        {
            audioSource.Play();
            return audioSource;
        }
        ...
        {
            CoroutineManager.DoAfterGivenTime(audioSource.clip.length, completeCallback.SafeInvoke);
            return audioSource;
        }
        ...
        public static AudioSource SetBeforeComplete(this AudioSource audioSource, float time, Action completeCallback)
        {
            ...
            CoroutineManager.DoAfterGivenTime(audioSource.clip.length - time, completeCallback.SafeInvoke);
            return audioSource;            
        }   
    }
}
