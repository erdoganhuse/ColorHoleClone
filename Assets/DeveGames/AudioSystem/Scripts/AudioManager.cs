...
namespace DeveGames.AudioSystem.Scripts
{
    ...
    public class AudioManager
    {
        ...
        public bool IsBackgroundMusicMuted
        {
            ...
            private set => PlayerPrefs.SetInt(BackgroundMusicVolumeKey + MuteKey, value.ToInt());
        }
        public bool IsSoundEffectMuted
        {
            ...
            private set => PlayerPrefs.SetInt(SoundEffectVolumeKey + MuteKey, value.ToInt());
        }
        ...
        public void Pause()
        {
            _activePlaylistDict.ForEach(item => item.Key.AudioSource.mute = true);
            _activeSoundEffectDict.ForEach(item => item.Key.mute = true);
        }

        public void Resume()
        {            
            _activePlaylistDict.ForEach(item => item.Key.AudioSource.mute = IsMasterMuted || IsBackgroundMusicMuted);
            _activeSoundEffectDict.ForEach(item => item.Key.mute = IsMasterMuted || IsSoundEffectMuted);
        }
        ...
        {
            AudioSource audioSource = GetAudioSource().SetClip(audioClip).CustomPlay();;
        ...
        public void ToggleBackgroundMusicVolume()
        {
            ...
            _activePlaylistDict.ForEach(item => item.Key.AudioSource.mute = IsBackgroundMusicMuted);
        ...
        public void ToggleSoundEffectVolume()
        {
            ...
            _activeSoundEffectDict.ForEach(item => item.Key.mute = IsSoundEffectMuted);
